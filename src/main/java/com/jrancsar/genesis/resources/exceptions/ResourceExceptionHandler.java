package com.jrancsar.genesis.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> request(HttpRequestMethodNotSupportedException e, HttpServletRequest request){		
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request){		
		String error = "The data entered is invalid";
		HttpStatus status = HttpStatus.BAD_REQUEST;
